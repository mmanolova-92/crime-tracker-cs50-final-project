...
def index():
    ...
    if request.method == "POST":
        ...
        db.execute("INSERT INTO crimeReports_users (date, time, crimeType, description, username) VALUES (%s, %s, %s, %s, %s)", (crimeDate_input, crimeTime_input, crimeType_input, crimeDescription_input, username))
        return redirect("/")
