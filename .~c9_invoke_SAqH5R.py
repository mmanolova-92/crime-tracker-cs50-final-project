...
def index():
    ...
    if request.method == "POST":
        ...
        db.execute("INSERT INTO crimeReports_news (date, time, crimeType, location, latLong, title, username, source) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)", (crimeDate_input, crimeTime_input, crimeType_input, crimeLocation_input, crimeLatLong_input, crimeDescription_input, username, "user"))
        return redirect("/")
