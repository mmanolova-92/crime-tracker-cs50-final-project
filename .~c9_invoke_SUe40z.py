...
def index():
    ...
    if request.method == "POST":
        ...
        db.execute("INSERT INTO crimeReports_users (date, time, crimeType, location, latLong, description, username) VALUES (%s, %s, %s, %s, %s, %s, %s)", (crimeDate_input, crimeTime_input, crimeType_input, "berlinweit", "52.520008, 13.404954", crimeDescription_input, username))
        return redirect("/")
        ...
        report_user_location = request.get_json()

        print(report_user_location)
        ...
        return render_template("index.html", reports_news = reports_news, reports_users = reports_users, tot_crimeType = tot_crimeType, tot_date = tot_date, tot_location = tot_location)
