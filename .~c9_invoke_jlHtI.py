...
def index():
    ...
    news_crime_reports_summary = db.execute("SELECT crimeType, count(id) FROM crimeReports_news GROUP BY crimeType")
    user_crime_reports_summary = db.execute("SELECT crimeType, count(id) FROM crimeReports_users GROUP BY crimeType")
