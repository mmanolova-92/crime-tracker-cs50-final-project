    ...
    if request.method == "POST":
        ...
        with open('crimes.json') as json_file:
            ...
            for entry in data:
                ...
                db.execute("INSERT INTO crimeReports_news (date, time, location, latLong, title, crimeType, source, link) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", date.replace('.','/'), time, location, latLong, title, crimeType, source)
