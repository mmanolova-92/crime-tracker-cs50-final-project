...
spiders = importlib.load_module('crimeAnalysis/crimeAnalysis/spiders/articles-sp')
module.function()
...
def index():
    ...
    print(articles-spider.crimeSpider.crimeTypes)
    ...
    news_crime_reports_summary_crimeType = db.execute("SELECT crimeType, count(id) FROM crimeReports_news GROUP BY crimeType")
    user_crime_reports_summary_crimeType = db.execute("SELECT crimeType, count(id) FROM crimeReports_users GROUP BY crimeType")

    news_crime_reports_summary_date_crimeType = db.execute("SELECT date, crimeType, count(id) FROM crimeReports_news GROUP BY date, crimeType")
    user_crime_reports_summary_date_crimeType = db.execute("SELECT date, crimeType, count(id) FROM crimeReports_users GROUP BY date, crimeType")
    ...
    return render_template("index.html", reports_news = reports_news, reports_news_count = reports_news_count)
